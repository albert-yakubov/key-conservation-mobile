package com.stepasha.keyconservation.logging;
...
{
    @Around(value = "@within(com.stepasha.mylocator.logging.Loggable) || @annotation(com.stepasha.mylocator.logging.Loggable)")
